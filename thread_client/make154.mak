...
cmd_tasks.o: Client154/cmd_tasks.c
	${CC} ${CC_FLAGS} ${INCLUDE_PATHS} -c Client154/cmd_tasks.c

tasks.o: Client154/tasks.c tasks.h
	${CC} ${INCLUDE_PATHS} ${CC_FLAGS} -c Client154/tasks.c
...
sched154: tasks.o cmd_tasks.o sched.o ioports.o assign_client_table.o load_cmds.o ollist_threads_rw.o rdwr.o serial_io.o config_file.o cllist_threads_rw.o cconfig_file.o
	${CC} -static -pthread tasks.o cmd_tasks.o sched.o ioports.o ollist_threads_rw.o rdwr.o serial_io.o config_file.o assign_client_table.o load_cmds.o cllist_threads_rw.o cconfig_file.o -o sched154 -lm
